...
The complete demo can be downloaded at :download:` Reconstruction CGLS Demo <../test/reconstruction_cgls.py>`
 . To run the demo you need to download the sample `dataset <https://github.com/DiamondLightSource/Savu/blob/master/test_data/data/24737_fd.nxs>`_  and install the following packages
